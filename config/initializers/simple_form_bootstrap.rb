...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, tag: 'div', class: 'row mb-3' do |b|
    b.use :html5
    b.optional :readonly
    # b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :form_check_wrapper, class: 'col-sm-9 offset-sm-3' do |d|
      d.wrapper :div, class: 'form-check' do |bb|
